                    ...
                    <div className="flex flex-col gap-5 max-w-sm">
                        <div className="flex items-center gap-3">
                            <div className="size-8 flex items-center justify-center text-cyan-400">
                                <span className="material-symbols-outlined !text-[28px]">auto_awesome_mosaic</span>
                            </div>
                        ...
                        <p className="text-slate-400 text-sm md:text-[15px] leading-relaxed">
                            Empowering creatives and professionals with precision prompt engineering.
                            Optimize, analyze, and refine your AI interactions in a premium workspace.
                        </p>
                ...
                <div className="mt-16 pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10">
                            <p className="text-slate-500 text-xs font-medium tracking-wider">VERSION</p>
                        ...
                        <div className="flex items-center gap-2.5">
                            ...
                            <p className="text-slate-400 text-xs font-semibold uppercase tracking-widest translate-y-[0.5px]">Systems Online</p>
                        </div>
                    </div>
                </div>
            </div>
...
const SocialIcon = ({ icon, label }: { icon: string; label: string }) => (
    <button
        ...
        aria-label={label}
    >
        <span className="material-symbols-outlined text-[20px] transition-transform group-hover:scale-110">{icon}</span>
    </button>
);

            ...
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <div className="size-8 flex items-center justify-center text-cyan-400">
                        <span className="material-symbols-outlined !text-[28px] sm:!text-[32px]">auto_awesome_mosaic</span>
                    </div>
                    <h2 className="text-white text-lg sm:text-xl font-black tracking-tight">Catalyst</h2>
                </div>

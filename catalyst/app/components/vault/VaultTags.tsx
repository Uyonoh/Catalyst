...
const TAGS = [
  { label: 'All Prompts', color: 'bg-white', text: 'text-[#101922]', active: true },
  ...
  return (
    <div className="flex gap-3 mb-8 overflow-x-auto pb-2 dropdown-scroll">
      {TAGS.map((tag) => {
        ...
        const borderHover = tag.color.replace('bg-', 'hover:border-').replace('-400', '-400/50').replace('primary', 'primary/50');

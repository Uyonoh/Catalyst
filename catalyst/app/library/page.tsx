...
async function getLibraryItems(searchParams: { 
  ...
  if (searchParams.modes) {
    ...
    filteredData = filteredData.filter((item: any) => {
      ...
      if (modesArray.includes('image') && (model.includes('midjourney') || model.includes('dall-e') || model.includes('stable diffusion'))) return true;
      if (modesArray.includes('video') && (model.includes('veo') || model.includes('sora'))) return true;
      if (modesArray.includes('text') && !(model.includes('midjourney') || model.includes('dall-e') || model.includes('stable diffusion') || model.includes('veo'))) return true;
      return false;
    });
  }
